...
class ChatController {
    async chat(req: AuthRequest, res: Response, next: NextFunction) {
        try {
            ...
            let context = `You are PetBot, an AI assistant for Petopia - a social media app for pet owners.\n\n`;
            ...
            if (userPosts.length > 0) {
                ...
                userPosts.forEach((post: any, idx) => {
            ...
            recentCommunityPosts.forEach((post: any, idx) => {
